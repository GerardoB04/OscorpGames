namespace OscorpGames {
	partial class Menu {
		...
		private void InitializeComponent() {
			...
			titleLabel.Font = new Font("Segoe UI", 40F);
			...
			minesweeperToolStripMenuItem.Click += minesweeperToolStripMenuItem_Click;
			// 
			...
			snakeToolStripMenuItem.Click += snakeToolStripMenuItem_Click;
			// 
			...
			pacManToolStripMenuItem.Click += pacManToolStripMenuItem_Click;
			// 
			...
			tetrisToolStripMenuItem.Click += tetrisToolStripMenuItem_Click;
			// 
			// Menu
			// 
